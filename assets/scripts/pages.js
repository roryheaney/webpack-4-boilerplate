const sampleComponents = require('./components/sample'),
	  SCROLL_COMPONENTS = require('./components/scroll');
	...
	var FancySquares = {
		...
		'common': {
	  		init: function() {
				...
				sampleComponents.testingFunction();
				SCROLL_COMPONENTS.rmh_pageScroll();
